...
function NavElm() {
    return (
        <nav
            id='header'
            className='fixed w-full backdrop-blur-2xl bg-[#ffffff33] z-30 top-0 text-white'>
            <div className='w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2'>
                ...
                <div
                    className='flex-grow flex items-center w-auto mt-0 bg-white bg-transparent text-black p-0 z-20'
                    id='nav-content'>
                ...
                <div className='container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center'>
                    ...
                    <div className='flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left'>
                        <p className='uppercase tracking-loose w-full'>
                            We are a simple ChatApp
                        </p>
                        <h1 className='my-4 text-5xl font-bold leading-tight'>
                            The most Powerfull messenger app for developers!
                        </h1>
                        <p className='leading-normal text-2xl mb-8'>
                            Chat with your team-mates, Create Good Apps, Change the World,
                            Make It Better!
                        </p>
...
function LandingElm() {
    return (
        <div className='bg-gradient-to-r from-[#d53369] to-[#daae51] text-white landing-normal'>
            <NavElm />
            <HeroElm />
            <Section1Elm />
        </div>
